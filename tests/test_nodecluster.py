...
class NodeClusterTestCase(unittest.TestCase):
    ...
    def test_nodecluster_list(self, mock_send):
        ...
        clusters = tutum.NodeCluster.list()
    ...
    def test_nodecluster_fetch(self, mock_send):
        ...
        cluster = tutum.NodeCluster.fetch('b616a720-6684-42c6-83bb-4d298b11b3f3')
    ...
    def test_nodecluster_delete(self, mock_send):
        ...
        cluster = tutum.NodeCluster.fetch('e7915a74-618b-4908-9189-dce965465702')
